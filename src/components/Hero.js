export function Hero() {
  return `
    <section id="hero-section" class="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-navy pt-20 pb-24 md:pb-0">
        ...
        <div class="relative z-10 container mx-auto px-6 text-center max-w-4xl pt-8 md:pt-0">
            ...
            <div class="space-y-6 md:space-y-8 relative z-10">
                ...
                <p class="hero-subtitle text-base sm:text-lg text-white font-medium max-w-lg mx-auto font-body leading-relaxed text-shadow-strong">
                    Un condominio campestre exclusivo diseñado para fundirse con la selva de Sauce y las aguas de la Laguna Azul.
                </p>
        ...
        <div class="absolute bottom-6 md:bottom-10 left-0 right-0 z-10 px-6 container mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            <!-- Left: Sales info & Saber Más link (with subtle translucent badge for maximum readability on bright backgrounds) -->
            <div class="hero-bottom-left text-[11px] sm:text-sm text-white/95 font-body flex flex-col sm:flex-row items-center gap-3 sm:gap-4 bg-[#121820]/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 shadow-lg text-shadow-strong">
                <span>Lotes desde <strong class="text-white font-bold">$18,000 USD</strong> — 100% Vista Garantizada</span>
                <a href="#masterplan" class="inline-flex items-center gap-1 text-sun hover:text-white border-b border-sun/40 hover:border-white pb-0.5 transition-all group font-headline font-bold text-xs uppercase tracking-wider pl-0 sm:pl-2">
                    <span>Saber Más</span>
